...
date: 2020-12-29
description: "Configuring Windows Terminal to launch Docker containers as new tabs, creating instant debugging environments for Windows Server Core containers."
category: engineering
tags: [windows, docker, windows-terminal, powershell, containers, debugging]
---
...
![Windows Terminal settings](/assets/windowsterminal-settings.png)
...
![Windows Terminal drop-down menu](/assets/windowsterminal-dropdown.png)
